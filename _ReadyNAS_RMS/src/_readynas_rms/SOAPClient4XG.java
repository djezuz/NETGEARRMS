...
//	}
	...
	public static String connectionRun(String sessionId,String a,String fcml){//获得sessionId后进行数据交�?
		URL url;
		String result=null;
		try {
	...
	public static void connection(String a,Map<String,String> map){//连接到远�?
		URL url;
		try {
			url = new URL("https://genie.netgear.com/fcp/"+a);
			URLConnection connection = url.openConnection();
